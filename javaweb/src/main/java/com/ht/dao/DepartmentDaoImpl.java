...
public class DepartmentDaoImpl implements DepartmentDao {
	...
	@Override
	public void addDepartMent(String name,String phone,String officer,String remarks) throws Exception {
		// TODO Auto-generated method stub
		//默认没有删除为0
		String sql="insert into department values(null,?,?,?,?,0)";
		try {
			jdbc.update(sql,name,phone,officer,remarks);
	...
	public void editDepartmentById(String id,String name,String phone,String officer,String remarks) {
		// TODO Auto-generated method stub
		String sql="update department set name=?,phone=?,officer=?,remarks=? where id=?";
		jdbc.update(sql,name,phone,officer,remarks,id);
	}
